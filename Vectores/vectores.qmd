...
Sea $U=\{ (x,y,z) \in \mathbb{Q}^3 : x+2y-z=0\}$. Demuestra que $U$ es un subespacio vectorial de $\mathbb{Q}^3$ y encuentra una base de $U.$ <button id="e1-1" class="btn btn-light btn-sm" onclick="show(this.id);">Solución</button>
